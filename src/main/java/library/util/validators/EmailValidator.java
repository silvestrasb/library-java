...
public class EmailValidator {
    ...
    private final static String regexEmailPattern = "(?:[a-z0-9!#$%&'*+/=?^_`{|}~-]+(?:\\.[a-z0-9!#$%&'*+/=?^_`{|}~" +
    ...
    static public void validEmail(String email) throws InvalidEmailException {
        if (email.matches(regexEmailPattern)) return;
